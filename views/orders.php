...
<div class="panel panel-default">
  ...
  <table class="table" id="orders_table">
      <thead>
      <tr><th>Sl</th><th>Date Time</th><?php if($data['orderid']=='enabled'): ?><th>Order ID</th><?php endif ?><th>Phone</th><th>Amount</th><th>Status</th><th>Action</th></tr>
      </thead>
